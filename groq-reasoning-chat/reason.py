...
def main():
    st.set_page_config(page_title="Groq Reasoning", page_icon="🧠", layout="wide")
    
    st.title("Using Llama-3.1 70b on Groq to create o1-like reasoning chains")
    ...
    Based on [Open source repository](https://github.com/bklieger-groq)
    """)
